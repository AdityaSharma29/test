...
var map = new google.maps.Map(document.getElementById("googleMap"), myMap(26.79959, 82.20414));

document.getElementById('inner-img-cnt').innerHTML = "<img src='abbey falls.jpg'><img src='abbey falls(1).jfif'><img src='abbey falls(2).jpg'><img src='abbey falls(3).jpg'>" ;
